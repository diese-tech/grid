  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={reduceMotion ? { opacity: 1 } : { scale: 1.02, y: 0, opacity: 0.88 }}
        transition={{ delay: reduceMotion ? 0 : 0.46, duration: 0.82, ease: [0.16, 1, 0.3, 1] }}
      >
        <Image
      ...
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(3,7,18,0.72),rgba(3,7,18,0.08)_50%,rgba(3,7,18,0.72)),radial-gradient(circle_at_center,rgba(103,232,249,0.16),transparent_42%)]" />
      ...
      <motion.div
        ...
        animate={reduceMotion ? undefined : { scale: [0.16, 0.72, 2.9], opacity: [0, 0.7, 0], rotateX: 68 }}
        transition={{ duration: 1.26, ease: [0.2, 0.9, 0.2, 1] }}
        aria-hidden="true"
      />
      ...
      <motion.div
        ...
        animate={reduceMotion ? undefined : { rotateX: 72, scaleY: [0.22, 2.4, 0.12], opacity: [0, 0.58, 0] }}
      ...
      <motion.div
        ...
        animate={reduceMotion ? undefined : { scaleY: [1, 0.72, 0.92] }}
      ...
      <motion.div
        ...
        animate={reduceMotion ? undefined : { y: -140, rotate: -8, opacity: [0, 0.78, 0.08] }}
      ...
      <motion.div
        ...
        animate={reduceMotion ? undefined : { y: -190, rotate: 6, opacity: [0, 0.65, 0] }}
      ...
      <motion.div
        ...
        animate={reduceMotion ? undefined : { scaleX: [0.2, 3.6, 0.4], opacity: [0, 0.62, 0] }}
      ...
      <motion.div
        ...
        animate={reduceMotion ? undefined : { opacity: [0, 0.58, 0], scale: [0.82, 1.2, 1.86] }}
        transition={{ delay: 0.42, duration: 0.76, ease: "easeInOut" }}
        aria-hidden="true"
      />

      <motion.div
        className="absolute inset-x-0 bottom-16 mx-auto w-fit border border-cyan-100/20 bg-black/20 px-4 py-2 font-mono text-xs uppercase tracking-[0.18em] text-cyan-50/85 backdrop-blur-[1px]"
        initial={reduceMotion ? false : { opacity: 0, y: 12 }}
        animate={reduceMotion ? undefined : { opacity: [0, 0.9, 0.9], y: [12, 0, 0] }}
        transition={{ delay: 0.78, duration: 0.82, ease: "easeOut" }}
      >
        Lab visual acquired
      </motion.div>
